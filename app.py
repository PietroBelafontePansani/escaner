...
# Configuração essencial para servidores Cloud (Render): impede que o YOLO 
# tente criar/baixar fontes em diretórios globais sem permissão de escrita.
...
# 2. Carregamento do modelo YOLO (utilizando cache para economizar RAM no Render)
@st.cache_resource
def load_yolo_model():
    # Carrega o modelo YOLOv8 Nano (apenas ~6MB), ideal para o plano gratuito do Render
